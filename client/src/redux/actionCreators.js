...
export const fetchData = (token, callback) => {
  ...
  return (dispatch) => {
    ...
    axios
      .get(apiUrl + `/api/dashboard/resume/all/${user.id}`, {
        headers: {
          "Content-Type": "application/json",
          "auth-token": token,
        },
...
export const postData = (token, resume) => {
  ...
  return (dispatch) => {
    ...
    axios({
      url: apiUrl + `/api/dashboard/resume`,
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "auth-token": token,
...
export const updateData = (token, resume) => {
  ...
  return (dispatch) => {
    ...
    axios({
      url: apiUrl + `/api/dashboard/resume/${resume._id}`,
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-token": token,
...
export const updateUser = (newUser, token) => {
  ...
  return (dispatch) => {
    ...
    axios({
      url: apiUrl + `/api/dashboard/user/${user.id}`,
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-token": token,
